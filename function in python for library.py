...
def run():
    ...
    if a == 1:
            ...
            print("Invaild input given")
run()
def book():
    print("press 1 for book1: To Kill a Mockingbird by Harper Lee")
    print("press 2 for book2: 1984 by George Orwell")
    print("press 3 for book3: The Alchemist by Paulo Coelho")
    print("press 4 for book4: The Great Gatsby by F. Scott Fitzgerald")
    print("press 5 for book5: Harry Potter and the Sorcerer’s Stone by J.K. Rowling")
